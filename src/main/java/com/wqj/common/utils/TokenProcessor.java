...
import com.wqj.common.utils.pojo.Globals;
...
public class TokenProcessor {
    ...
    public synchronized boolean isTokenValid(HttpServletRequest request,
        ...
        String suffix = request.getParameter(Globals.TOKEN_KEY_SUFFIX);
        String saved =
            (String) session.getAttribute(Globals.TRANSACTION_TOKEN_KEY + suffix);
        ...
        String token = request.getParameter(Globals.TOKEN_KEY + suffix);
        if (token == null) {
            return false;
        }
    ...
    public synchronized void resetToken(HttpServletRequest request) {
        ...
        String suffix = request.getParameter(Globals.TOKEN_KEY_SUFFIX);
        session.removeAttribute(Globals.TRANSACTION_TOKEN_KEY + suffix);
    }
    ...
    public synchronized String saveToken(HttpServletRequest request) {
        ...
        if (token != null) {
            ...
            session.setAttribute(Globals.TRANSACTION_TOKEN_KEY + suffix, token);
            request.setAttribute(Globals.TOKEN_KEY_SUFFIX,suffix);
        }
        return token;
    }
