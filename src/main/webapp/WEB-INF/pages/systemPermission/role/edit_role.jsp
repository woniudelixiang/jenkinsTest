...
<body>
	<form action="${ctx }/sys/role/editRole" method="POST">
				...
				<td>
					...
					<option value="">-请选择-</option>
						<c:forEach var="parentRole" items="${parentRoleList }">
							<option value="${parentRole.roleId }" ${systemRole.parentRole.roleId eq parentRole.roleId ? 'selected':'' }>${parentRole.roleName }</option>
						</c:forEach>
					</select>
				</td>
			</tr>
