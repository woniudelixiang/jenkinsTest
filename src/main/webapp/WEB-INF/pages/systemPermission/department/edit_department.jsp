				...
				<td>
					...
					<option value="">-请选择-</option>
						<c:forEach var="parentDepartmentId" items="${resultList }">
							<option value="${parentDepartmentId.departmentId }" ${department.parentDepartment.departmentId eq parentDepartmentId.departmentId ? 'selected':'' }>${parentDepartmentId.departmentName }</option>
						</c:forEach>
					</select>
				</td>
			</tr>
