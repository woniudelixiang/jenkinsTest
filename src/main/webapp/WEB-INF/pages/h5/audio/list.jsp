...
<html>
<head>
<title>html5 audio音频播放  http://www.cnblogs.com/leinov/p/3896772.html</title>
    <style>
        *{ margin: 0; padding:0;}
...
<body>
	...
	<!--播放时间end-->
	<!--歌曲信息start-->
	<div id="songInfo">没时间-Leinov<div class="shareImg"><img src="${ctx }/images/create_new.jpg" alt=""></div></div>
	<!--歌曲信息end-->
	...
	<script type="text/javascript">
		...
		function getSong() { 
		    ...
		    audio.src = "http://192.168.1.55:38080/upload/170405/0372925b-e14b-41c1-b3aa-bcaaebeff836.mp3";
		    audio.loop = true; //歌曲循环
		    audio.pause();  // 一开始进入的时候不播放
		    playCotrol(); //播放控制函数
		}
